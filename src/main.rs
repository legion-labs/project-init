...
use colored::*;
use git2::Repository;
use project_init::args::{Args, Subcommands};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match args.subcommand {
        ...
        Subcommands::Git { repo, name, force } => {
            // form the URL
            ...
            let (parsed_toml, _) = read_toml_dir(&toml_string, ".");
        ...
        Subcommands::New {
            ...
            let template_str_lower: String = template
                .chars()
            ...
            match template_str {
                ...
                "julia" => {
                    ...
                    project_path.push_str(&name.to_capitalized());
        ...
        Subcommands::Init {
            ...
            let mut template_path = directory.clone();
            template_path.push_str("/template.toml");
            let (parsed_toml, is_global_project) = read_toml_dir(&template_path, &home);
